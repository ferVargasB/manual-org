...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Crear Proceso para una sub área
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelos/modelo-proceso-subarea.php" enctype="multipart/form-data">
                            <div class="box-body" id="div_proceso">
                                ...
                                <div class="form-group">
                                    <label for="area_perteneciente">Sub Área:</label>
                                    <select name="subarea_perteneciente" id="subarea_perteneciente" class="form-control" required>
                                        <!-- Codigo PHP  -->
                                        <?php
                                        try {
                                            $stmt = $objetoPDO->prepare("SELECT id_subarea,nombre FROM sub_areas ORDER BY nombre");
                                            $stmt->execute();
                                            $resultado = $stmt->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($resultado as $row) { ?>
                                                <option value="<?php echo $row['id_subarea']; ?>"><?php echo $row["nombre"]; ?></option>
                                        <?php }
                                        } catch (Exception $th) {
                                            throw $e->getMessage();
                                        }
    ...
    <script src="js/proceso-ajax-subarea.js"></script>
</body>
