...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      subarea_perteneciente FROM procesos_subareas WHERE id_proceso = :id");
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subarea_perteneciente" id="subarea_perteneciente" class="form-control" required>
                                        ...
                                        foreach ($resultado_areas as $row) { ?>
                                            <option value="<?php echo $row['id_subarea']; ?>" <?php if ($row["id_subarea"] == $resultado[0]["subarea_perteneciente"]) {
                                                                                                        echo "selected";
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="numero_actores" class="form-control" id="numero_actores">
                                        ...
                                        for ($contador = 0; $contador < 15; $contador++) { ?>
                                            <option value="<?php echo $contador; ?>" <?php if ($contador == $resultado[0]["numero_actores"]) {
                                                                                                echo "selected";
    ...
    <script src="js/editar-proceso-subarea.js"></script>
</body>
