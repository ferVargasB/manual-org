    ...
    <div class="wrapper">
        ...
        try {
            ...
            SELECT
                ...
                pd.ruta_ficha,
                pd.numero_actores,
                pd.dependencia_perteneciente,
                pad.id_proceso_dependencia,
                pad.id_actor,
                a.id_actor,
                a.nombre,
                a.es_director,
                a.ruta_atribucion
            FROM
                procesos_dependencias AS pd
            INNER JOIN procesos_actores_dependencias AS pad
            ON
                pd.id_proceso = pad.id_proceso_dependencia
            INNER JOIN actores AS a
            ON
                pad.id_actor = a.id_actor
            WHERE
                pd.id_proceso = :id
            ORDER BY
                es_director
