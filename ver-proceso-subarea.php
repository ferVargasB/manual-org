...
<head>
    ...
    $ida = 0;
    $idp = 0;
    if (isset($_GET['ida']) && isset($_GET['idp']) && isset($_GET['ids'])) {
        $ids = $_GET["ids"];
        $ida = $_GET["ida"];
        $idp = $_GET["idp"];
    }
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <?php
        try {
            $stmt = $objetoPDO->prepare("SELECT 
      ps.id_proceso,ps.nombre AS nombre_proceso,ps.ruta_diagrama,ps.ruta_ficha,ps.numero_actores,ps.subarea_perteneciente,
      pas.id_proceso_subarea,pas.id_actor,
      a.id_actor,a.nombre,a.es_director,a.ruta_atribucion
      ...
      ON pas.id_actor = a.id_actor
      WHERE ps.id_proceso = :id ORDER BY es_director DESC;");
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <?php
                            if ($ida != 0 && $idp != 0 && $ids != 0) { ?>
                                <a href="lista-procesos-subareas.php?ids=<?php echo $ids.'&ida='.$ida.'&idp='.$idp;?>" class="btn btn-primary active director" role="button" aria-pressed="true">Regresar</a>
                            <?php } else { ?>
