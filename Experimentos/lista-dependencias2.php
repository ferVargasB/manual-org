                ...
                <tbody>
                  ...
                  foreach($resultado as $row)
                  {
                    ...
                    <tr class="">
                      ...
                      <td><a href="<?php echo $row['ruta_objetivo_general'];?>" target="_blank">Ver Objetivo General</a></td>
                      <td><a href="<?php echo $row['ruta_perfil_puesto'];?>" target="_blank">Ver Perfil de Puesto</a></td>
                      <td><a href="<?php echo $row['ruta_atribuciones'];?>" target="_blank">Ver Atribuciones</a></td>
                      <td>
