...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Crear Área
        <small>llenar el formulario para crear una área y vincularla a una dependencia</small>
      </h1>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelos/modelo-area.php">
            <div class="box-body">
              <div class="form-group">
                <label for="usuario">Nombre:</label>
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Escriba el nombre del area" required>
              </div>
              <div class="form-group">
