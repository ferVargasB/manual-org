...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
      ...
      dependencia_perteneciente FROM procesos_dependencias WHERE id_proceso = :id");
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form enctype="multipart/form-data" name="actualizar-registro" id="actualizar-registro" method="post" action="modelos/modelo-proceso-dependencia.php">
                            ...
                            <div class="box-body" id="div_proceso">
                                ...
                                <div class="form-group">
                                    <label for="dependencia_perteneciente">Dependencia:</label>
                                    <select name="dependencia_perteneciente" id="dependencia_perteneciente" class="form-control" required>
                                        <!-- Codigo PHP  -->
                                        <?php
    ...
    <script src="js/editar-proceso-dependencia.js"></script>
</body>
